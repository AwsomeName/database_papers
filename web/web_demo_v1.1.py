...
def predict(input, max_length, top_p, temperature, history=None):
    ...
    with container:
        ...
        with st.empty():
            m_input = system_token + "\n" + system_msg + end_token + "\n" + user_token + "\nthe questions is: \"" + en_input + "\"\n please read the papers title and abstract: " + search_str + ". now answer the question " + en_input + "? if the method proposed by the paper could answer the question? " + end_token + "\n" + assistant_token + "\n"
